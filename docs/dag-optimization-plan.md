...
- Analyze SQL eligibility lazily, caching each visited logical node and stopping at known boundaries. Report lowering, capability, and SQL-preparation boundary reasons with `ORCHIDDB_EXPLAIN_DAG=1`.
