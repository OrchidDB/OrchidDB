...
3. Add conservative DAG rewrites with explicit eligibility. Preserve SQL scope barriers, ordering, side effects, and duplicate evaluation. Do not enable an unrestricted optimizer pass over opaque kernels.
