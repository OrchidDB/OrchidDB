...
use super::super::scalar::temporal;
...
pub(crate) fn compare_values(a: &Value, b: &Value) -> std::cmp::Ordering {
    ...
    match (a, b) {
        ...
        (Value::CardinalityValue {..},Value::CardinalityValue {..}) => crate::ir::value::set_member_key(a).cmp(&crate::ir::value::set_member_key(b)),
