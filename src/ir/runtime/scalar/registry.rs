...
/// Explicit scalar operator inventory. Unknown engine functions must never
/// reach the scalar evaluator's generic null-propagation fallback during folding.
...
const KNOWN_FUNCTIONS: &[&str] = &[
    ...
    "cypher_coalesce",
    "cypher_slice_bound",
    "cypher_live_property",
    "cypher_nodes",
    "cypher_relationships",
    "cypher_property_value",
    "cypher_property_map",
    "cypher_merge_valid",
    ...
    "cypher_slice",
    "cypher_star",
    "cypher_temporal.date",
    "cypher_temporal.date.truncate",
    "cypher_temporal.datetime",
    "cypher_temporal.datetime.fromepoch",
    "cypher_temporal.datetime.fromepochmillis",
    "cypher_temporal.datetime.truncate",
    "cypher_temporal.duration",
    "cypher_temporal.duration.between",
    "cypher_temporal.duration.indays",
    "cypher_temporal.duration.inmonths",
    "cypher_temporal.duration.inseconds",
    "cypher_temporal.localdatetime",
    "cypher_temporal.localdatetime.truncate",
    "cypher_temporal.localtime",
    "cypher_temporal.localtime.truncate",
    "cypher_temporal.time",
    "cypher_temporal.time.truncate",
    ...
    "uuid",
    "value_map",
    "value_map_modulator_entries",
    "value_map_modulator_result",
    "value_map_tokens",
    "var_macro",
    "xor",
];
