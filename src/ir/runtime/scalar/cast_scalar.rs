...
fn timestamp_parse_error(raw: &str) -> RuntimeError {
...
fn invalid_uuid_error(raw: &str) -> RuntimeError {
    RuntimeError::Runtime(format!("Conversion exception: Invalid UUID: {raw}"))
}
