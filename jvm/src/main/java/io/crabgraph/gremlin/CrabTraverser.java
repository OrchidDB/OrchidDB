...
final class CrabTraverser {
    private CrabTraverser() { }
    @SuppressWarnings("unchecked")
    static Traverser<?> create(Map<String,Object> frame, CrabGraph graph) {
        Map<String,Object> state=new LinkedHashMap<>();
        ((Map<String,Object>)frame.get("bindings")).forEach((k,v)->state.put(k,CrabCodec.decode(v,graph)));
        ...
        return (Traverser<?>)Proxy.newProxyInstance(CrabTraverser.class.getClassLoader(),new Class<?>[]{Traverser.class},(proxy,method,args)->{
