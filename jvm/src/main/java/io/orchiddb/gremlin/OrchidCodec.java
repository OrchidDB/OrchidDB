...
public final class OrchidCodec {
    private OrchidCodec() {}
    ...
    public static Object encode(Object value,OrchidGraph graph) {
        ...
        if (value instanceof OrchidProperty) return ((OrchidProperty<?>)value).record;
        String type;
    ...
    private static Object encodeReferenceId(Object id,OrchidGraph graph,String type) {
    ...
    public static Object decode(Object raw, OrchidGraph graph) {
        ...
        switch(type) {
            ...
            case "vertex": return new OrchidVertex(graph,record);
            case "edge": return new OrchidEdge(graph,record);
            case "vertex_property": return new OrchidVertexProperty<>(graph,record);
            case "property": return new OrchidProperty<>(graph,record);
            case "path": {
