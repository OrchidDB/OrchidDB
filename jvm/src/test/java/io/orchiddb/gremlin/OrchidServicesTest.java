...
public class OrchidServicesTest {
    @Test public void servicesScanArbitraryNativeTopologyAndMetaProperties() {
        String binary=System.getenv("ORCHIDDB_JVM_STORE"); Assume.assumeNotNull(binary);
        try(OrchidGraph graph=OrchidGraph.open(binary)) {
