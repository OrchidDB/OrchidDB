package io.orchiddb.gremlin.contract;
...
public class OrchidProviderContractTest {
    ...
    @Test public void graphFactoryPreservesConfigurationAndCreatesMissingDirectories() throws Exception {
        Path directory=Files.createTempDirectory("orchiddb-factory-");
        ...
        configuration.setProperty("orchiddb.native.path",directory.resolve("missing/nested/graph.ngsp").toString());
