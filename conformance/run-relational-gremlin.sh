...
export ORCHIDDB_JAVA="$CONFORMANCE_JAVA"
...
export ORCHIDDB_JVM_CLASSPATH="$repo_root/jvm/target/classes:$(cat jvm/target/classpath.txt)"
...
export ORCHIDDB_GREMLIN_IO_JAVA="$CONFORMANCE_JAVA"
