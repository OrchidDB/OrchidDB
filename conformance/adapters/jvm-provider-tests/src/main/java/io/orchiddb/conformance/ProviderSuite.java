...
public final class ProviderSuite {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean computer = selection.equals("ProcessComputerSuite") || Boolean.getBoolean("orchiddb.test.computer");
        ...
        for(String key:List.of("is.testing","assertNonDeterministic","orchiddb.test.computer","build.dir"))
